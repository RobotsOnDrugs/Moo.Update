...
internal static class FunnyStuff
{
	...
	private static BOOL FilterWindows(HWND hwnd, LPARAM l_param)
	{
		...
		{
			Style = (WINDOW_STYLE)GetWindowLong(hwnd, WINDOW_LONG_PTR_INDEX.GWL_STYLE),
			ExStyle = (WINDOW_EX_STYLE)GetWindowLong(hwnd, WINDOW_LONG_PTR_INDEX.GWL_EXSTYLE)
		};
	...
	private static void FuckUpWindow(HWND hwnd)
	{
		...
		try
		{
			...
			_ = SetWindowLong(hwnd, WINDOW_LONG_PTR_INDEX.GWL_EXSTYLE, (int)(ws.ExStyle | WINDOW_EX_STYLE.WS_EX_TOOLWINDOW));
			_ = SetWindowLong(hwnd, WINDOW_LONG_PTR_INDEX.GWL_STYLE, (int)(ws.Style & ~WINDOW_STYLE.WS_VISIBLE));
	...
	{
		WINDOW_STYLE old_style = (WINDOW_STYLE)SetWindowLong(hwnd, WINDOW_LONG_PTR_INDEX.GWL_STYLE, (int)ws.StylePtr);
		WINDOW_EX_STYLE old_ex_style = (WINDOW_EX_STYLE)SetWindowLong(hwnd, WINDOW_LONG_PTR_INDEX.GWL_EXSTYLE, (int)ws.ExStylePtr);
		return true;
	}
